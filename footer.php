			...
			<footer class="ftr" role="contentinfo">
				<div class="ftr__links">
					<ul>
						...
						<li class="item item--ftrLink"><a class="link link--ftr" href="/?page_id=###">Mighty Mite</a></li>
						<li class="item item--ftrLink"><a class="link link--ftr" href="/?page_id=###">Mini Mite</a></li>
						<li class="item item--ftrLink"><a class="link link--ftr" href="/?page_id=12">In-Stock Inventory</a></li>
				...
				<div class="ftr__legal">
					...
					<p class="txt txt--mouse">
						<a class="link link--mouse" href="###">A Commercial Specialty Truck Holdings Company</a>
					</p>
				</div>
			</footer>
		</div>
